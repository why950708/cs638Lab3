...
public class oneLayer{
	...
	*/
	...
	Vector<Vector<Double>> testfeatureVectors)
	{
		...
		nn=new NNImpl(trainingSet, Lab3.numberOfHiddenUnits, learningRate, Lab3.maxEpochs,
...
class Node{
	...
	public Vector<NodeWeightPair> parents=null; //Array List that will contain the parents (including the bias node) with weights if applicable
 ...
 * Attributes are represented as an Vector of Doubles
 * Class labels are represented as an Vector of Integers. For example,
